...
class strategieCarre:
    #ceci est une strategie qui realise un carré de 70cm de cote
    #A TESTER EN VRAI !
    ...
    if dist >= 60 and dist < 70 :
        ...
        #faire tourner le moteur droit dans le sens oppose => rotation du robot par rapport a son centre
