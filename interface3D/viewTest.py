...
class ViewRobot:
    ...
    def __init__(self, batch, robot):
        ...
        va=(robot.DIMENSIONS[1]/2,robot.DIMENSIONS[0]/2)
        va2=(va[0]*robot.getDirVect()[0]-va[1]*robot.getDirVect()[1],va[0]*robot.getDirVect()[0]+va[1]*robot.getDirVect()[0])
        vb=(robot.DIMENSIONS[1]/2,-robot.DIMENSIONS[0]/2)
        vb2=(vb[0]*robot.getDirVect()[0]-vb[1]*robot.getDirVect()[1],vb[0]*robot.getDirVect()[0]+vb[1]*robot.getDirVect()[0])
        vc=(-robot.DIMENSIONS[1]/2,robot.DIMENSIONS[0]/2)
        vc2=(vc[0]*robot.getDirVect()[0]-vc[1]*robot.getDirVect()[1],vc[0]*robot.getDirVect()[0]+vc[1]*robot.getDirVect()[0])
        vd=(-robot.DIMENSIONS[1]/2,-robot.DIMENSIONS[0]/2)
        vd2=(vd[0]*robot.getDirVect()[0]-vd[1]*robot.getDirVect()[1],vd[0]*robot.getDirVect()[0]+vd[1]*robot.getDirVect()[0])
